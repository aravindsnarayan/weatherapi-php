...
class APIsApi
{
     ...
     * @param  string $alerts Enable/Disable alerts in forecast API output. Example, alerts&#x3D;yes or alerts&#x3D;no. (optional)
     * @param  string $aqi Enable/Disable Air Quality data in forecast API output. Example, aqi&#x3D;yes or aqi&#x3D;no. (optional)
     * @param  int $tp Get 15 min interval or 24 hour average data for Forecast and History API. Available for Enterprise clients only. E.g:- tp&#x3D;15 (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function forecastWeather($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null, $alerts = null, $aqi = null, $tp = null)
    {
        list($response) = $this->forecastWeatherWithHttpInfo($q, $days, $dt, $unixdt, $hour, $lang, $alerts, $aqi, $tp);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function forecastWeatherWithHttpInfo($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null, $alerts = null, $aqi = null, $tp = null)
    {
        $returnType = 'object';
        $request = $this->forecastWeatherRequest($q, $days, $dt, $unixdt, $hour, $lang, $alerts, $aqi, $tp);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forecastWeatherAsync($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null, $alerts = null, $aqi = null, $tp = null)
    {
        return $this->forecastWeatherAsyncWithHttpInfo($q, $days, $dt, $unixdt, $hour, $lang, $alerts, $aqi, $tp)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forecastWeatherAsyncWithHttpInfo($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null, $alerts = null, $aqi = null, $tp = null)
    {
        $returnType = 'object';
        $request = $this->forecastWeatherRequest($q, $days, $dt, $unixdt, $hour, $lang, $alerts, $aqi, $tp);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function forecastWeatherRequest($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null, $alerts = null, $aqi = null, $tp = null)
    {
        // verify the required parameter 'q' is set
        if ($q === null || (is_array($q) && count($q) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($alerts !== null) {
            $queryParams['alerts'] = ObjectSerializer::toQueryValue($alerts);
        }
        // query params
        if ($aqi !== null) {
            $queryParams['aqi'] = ObjectSerializer::toQueryValue($aqi);
        }
        // query params
        if ($tp !== null) {
            $queryParams['tp'] = ObjectSerializer::toQueryValue($tp);
        }
    ...
    /**
     * Operation marineWeather
     *
     * Marine Weather API
     *
     * @param  string $q Pass Latitude/Longitude (decimal degree) which is on a sea/ocean. Visit [request parameter section](https://www.weatherapi.com/docs/#intro-request) to learn more. (required)
     * @param  int $days Number of days of weather forecast. Value ranges from 1 to 7 (required)
     * @param  \DateTime $dt Date should be between today and next 7 day in yyyy-MM-dd format. e.g. &#39;2023-05-20&#39; (optional)
     * @param  int $unixdt Please either pass &#39;dt&#39; or &#39;unixdt&#39; and not both in same request. unixdt should be between today and next 7 day in Unix format. e.g. 1490227200 (optional)
     * @param  int $hour Must be in 24 hour. For example 5 pm should be hour&#x3D;17, 6 am as hour&#x3D;6 (optional)
     * @param  string $lang Returns &#39;condition:text&#39; field in API in the desired language.&lt;br /&gt; Visit [request parameter section](https://www.weatherapi.com/docs/#intro-request) to check &#39;lang-code&#39;. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @return object
     */
    public function marineWeather($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null)
    {
        list($response) = $this->marineWeatherWithHttpInfo($q, $days, $dt, $unixdt, $hour, $lang);
        return $response;
    }

    /**
     * Operation marineWeatherWithHttpInfo
     *
     * Marine Weather API
     *
     * @param  string $q Pass Latitude/Longitude (decimal degree) which is on a sea/ocean. Visit [request parameter section](https://www.weatherapi.com/docs/#intro-request) to learn more. (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function marineWeatherWithHttpInfo($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null)
    {
        $returnType = 'object';
        $request = $this->marineWeatherRequest($q, $days, $dt, $unixdt, $hour, $lang);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function marineWeatherAsync($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null)
    {
        return $this->marineWeatherAsyncWithHttpInfo($q, $days, $dt, $unixdt, $hour, $lang)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation marineWeatherAsyncWithHttpInfo
     *
     * Marine Weather API
     *
     * @param  string $q Pass Latitude/Longitude (decimal degree) which is on a sea/ocean. Visit [request parameter section](https://www.weatherapi.com/docs/#intro-request) to learn more. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function marineWeatherAsyncWithHttpInfo($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null)
    {
        $returnType = 'object';
        $request = $this->marineWeatherRequest($q, $days, $dt, $unixdt, $hour, $lang);
    ...
    /**
     * Create request for operation 'marineWeather'
     *
     * @param  string $q Pass Latitude/Longitude (decimal degree) which is on a sea/ocean. Visit [request parameter section](https://www.weatherapi.com/docs/#intro-request) to learn more. (required)
     * @param  int $days Number of days of weather forecast. Value ranges from 1 to 7 (required)
     * @param  \DateTime $dt Date should be between today and next 7 day in yyyy-MM-dd format. e.g. &#39;2023-05-20&#39; (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function marineWeatherRequest($q, $days, $dt = null, $unixdt = null, $hour = null, $lang = null)
    {
        // verify the required parameter 'q' is set
        if ($q === null || (is_array($q) && count($q) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $q when calling marineWeather'
            );
        }
        // verify the required parameter 'days' is set
        if ($days === null || (is_array($days) && count($days) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $days when calling marineWeather'
            );
        }

        $resourcePath = '/marine.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
